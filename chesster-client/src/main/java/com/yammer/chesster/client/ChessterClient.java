package com.yammer.chesster.client;
...
public class ChessterClient {

    private final Client client;
    private final JerseyClientBuilder clientBuilder;
    private final URI root;

    public ChessterClient(Client client, URI root) {
        this.client = client;
        this.clientBuilder = null;
        this.root = root;
    }

    public ChessterClient(JerseyClientBuilder clientBuilder, URI root) {
        this.client = null;
